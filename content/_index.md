...
This paper explores firm conduct and labor outcomes in the Dutch prefabricated concrete industry amid growing housing demands. Using a novel dataset linking firm-level employee and production data, the study examines how firm interactions influence wages and pricing. Preliminary evidence from a post-cartel period suggests significant variability in prices and labor costs. Structural estimations of demand and production shed light on the implications of conduct assumptions. A calibrated simulation model assesses the potential market impacts of changes in labor dynamics, policy enforcement, and demand shocks. The findings aim to inform both academic literature and policy discussions on market behavior.


# Paper 2:  Labor Effects of Innovation Tax Breaks (with Sabien Dobbelaere)
...
# Paper 3: Measuring Advertising Spillovers in the Automobile Industry (with Jose-Luis Moraga Gonzalez and Sandor Zsolt)
